I now use https://github.com/bbatsov/prelude instead of my own .emacs.d
...
To produce the corresponding =~/.emacs.d/init.el= open the [[https://github.com/neilfigg/.emacs.d/blob/master/init.org][init.org]] and run =M-x org-babel-tangle= (=C-c C-v t=)
