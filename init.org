...
*** package clojure-mode [[https://github.com/clojure-emacs/clojure-mode][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
...
*** package-cider - [[https://github.com/clojure-emacs/cider][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
 (use-package cider
  :ensure t
  :config
...
*** package clj-refactor - [[https://github.com/clojure-emacs/clj-refactor.el][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
...
*** package cider-interaction - [[https://github.com/clojure-emacs/cider/blob/master/cider-interaction.el][GitHub page]]
...
*** package auto-complete -  [[https://github.com/auto-complete/auto-complete][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
...
*** package ac-cider -  [[https://github.com/clojure-emacs/ac-cider][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
...
*** package clojure-snippets - [[https://github.com/mpenet/clojure-snippets][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
...
*** package s - [[ https://github.com/magnars/s.el][GitHub page]]
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package s
   :ensure t)
#+END_SRC

*** package Hydras  [[https://github.com/abo-abo/hydra][GitHub page]] .
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package hydra
    :ensure t)
#+END_SRC
...
** Git
*** package magit [[https://github.com/magit/magit/wiki][project page]]
#+BEGIN_SRC emacs-lisp :tangle yes
(use-package magit                    
  :ensure t
